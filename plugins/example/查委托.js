...
export class DailyTask extends plugin {
   ...
   * 联系QQ: 1146638442，邮箱: info@hlhs-nb.cn
   * https://hlhs-nb.cn/download/查委托.js
   */
  ...
  get Data () {
    ...
    if (!data) {
      this.Res = this.Res || this.read('委托成就')
      data = this.Res.find(v => v.name == this.Name)
    }
